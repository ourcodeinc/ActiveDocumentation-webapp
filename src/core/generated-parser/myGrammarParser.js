...
myGrammarParser.SPACE = 19;
myGrammarParser.Alphabet = 20;
myGrammarParser.NL = 21;
myGrammarParser.LPAREN = 22;
myGrammarParser.RPAREN = 23;
myGrammarParser.NAME = 24;
myGrammarParser.ANNOTATION = 25;
myGrammarParser.EXTENSION = 26;
myGrammarParser.SUPERCLASS = 27;
myGrammarParser.IMPLEMENTATION = 28;
myGrammarParser.INTERFACE = 29;
myGrammarParser.FUNCTION = 30;
myGrammarParser.AbstractFunctions = 31;
myGrammarParser.CONSTRUCTOR = 32;
myGrammarParser.PARAMETER = 33;
myGrammarParser.TYPES = 34;
myGrammarParser.SPECIFIER = 35;
myGrammarParser.VISIBILITY = 36;
myGrammarParser.ReturnValue = 37;
myGrammarParser.DeclarationStatement = 38;
myGrammarParser.ExpressionStatement = 39;
myGrammarParser.InitialValue = 40;
myGrammarParser.CLASSES = 41;
...
myGrammarParser.prototype.combinatorialWords = function() {
    ...
    try {
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << myGrammarParser.T__6) | (1 << myGrammarParser.T__7) | (1 << myGrammarParser.T__8) | (1 << myGrammarParser.T__9) | (1 << myGrammarParser.T__10) | (1 << myGrammarParser.T__11) | (1 << myGrammarParser.SPACE) | (1 << myGrammarParser.Alphabet) | (1 << myGrammarParser.LPAREN) | (1 << myGrammarParser.RPAREN))) !== 0));
        this.state = 249;
        this.match(myGrammarParser.T__0);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
...
myGrammarParser.prototype.symbols = function() {
    ...
    try {
        ...
        this.state = 251;
        _la = this._input.LA(1);
        if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << myGrammarParser.T__6) | (1 << myGrammarParser.T__7) | (1 << myGrammarParser.T__8) | (1 << myGrammarParser.T__9) | (1 << myGrammarParser.T__10) | (1 << myGrammarParser.T__11) | (1 << myGrammarParser.LPAREN) | (1 << myGrammarParser.RPAREN))) !== 0))) {
...
myGrammarParser.prototype.have = function() {
    ...
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 275;
        this.match(myGrammarParser.T__16);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
