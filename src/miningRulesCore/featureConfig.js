...
export const featureGroupInformation = {
    field_spec_in_class: {
        ...
        desc: "Design rules for fields in similar classes",
    ...
    constr_spec_in_class: {
        ...
        desc: "Design rules for constructors in similar classes",
    ...
    func_spec_in_class: {
        ...
        desc: "Design rules for methods in similar classes",
        headers: ["IF a class has these properties", "THEN the class may have these methods"],
    ...
    subclass_spec_in_class: {
        ...
        desc: "Design rules for subclasses in similar classes",
    ...
    expr_spec_in_constr_calling_constr_focused_element: {
        ...
        desc: "Design rules for declaration statements in constructors calling the target constructor",
    ...
    expr_spec_in_func_calling_constr_focused_element: {
        ...
        desc: "Design rules for expression statements in methods calling the target constructor",
        headers: ["IF a method has these properties", "THEN the method may have these expressions"],
    ...
    decl_spec_in_func_calling_constr_focused_element: {
        ...
        desc: "Design rules for declaration statements in methods calling the target constructor",
        headers: ["IF a method has these properties", "THEN the method may have these declarations"],
    ...
    expr_spec_in_constr_calling_func_focused_element: {
        ...
        desc: "Design rules for expression statements in constructors calling the target method",
        headers: ["IF a constructor has these properties", "THEN the method may have these expressions"],
        mergeKeys: ["constructor", "expression statement"],
        categorizedFeatureSets: [["constr_identifier", "constr_spec"], []],
        rootId: [gui_element_ids.constr_element_id, gui_element_ids.constr_expr_stmt_id],
    },
    decl_spec_in_constr_calling_func_focused_element: {
        ...
        desc: "Design rules for declaration statements in constructors calling the target method",
        headers: ["IF a constructor has these properties", "THEN the method may have these declarations"],
        mergeKeys: ["constructor", "declaration statement"],
        categorizedFeatureSets: [["constr_identifier", "constr_spec"], []],
        rootId: [gui_element_ids.constr_element_id, gui_element_ids.constr_decl_stmt_id],
    },
    expr_spec_in_func_calling_func_focused_element: {
        ...
        desc: "Design rules for expression statements in methods calling the target method",
        headers: ["IF a method has these properties", "THEN the method may have these expressions"],
        mergeKeys: ["function", "expression statement"],
        categorizedFeatureSets: [["func_identifier", "func_spec"], []],
        rootId: [gui_element_ids.func_element_id, gui_element_ids.func_expr_stmt_id],
    ...
    decl_spec_in_func_calling_func_focused_element: {
        ...
        desc: "Design rules for declaration statements in methods calling the target method",
        headers: ["IF a method has these properties", "THEN the method may have these declarations"],
        mergeKeys: ["function", "declaration statement"],
        categorizedFeatureSets: [["func_identifier", "func_spec"], []],
        rootId: [gui_element_ids.func_element_id, gui_element_ids.func_decl_stmt_id],
    ...
    expr_spec_in_constr_reading_modifying_field_focused_element: {
        ...
        desc: "Design rules for expression statements in constructors reading / modifying the target field",
        headers: ["IF a constructor has these properties", "THEN the method may have these expressions"],
        mergeKeys: ["constructor", "expression statement"],
        categorizedFeatureSets: [["constr_identifier", "constr_spec"], []],
        rootId: [gui_element_ids.constr_element_id, gui_element_ids.constr_expr_stmt_id],
    ...
    decl_spec_in_constr_reading_modifying_field_focused_element: {
        ...
        desc: "Design rules for declaration statements in constructors reading / modifying the target field",
        headers: ["IF a constructor has these properties", "THEN the constructor may have these declarations"],
        mergeKeys: ["constructor", "declaration statement"],
        categorizedFeatureSets: [["constr_identifier", "constr_spec"], []],
        rootId: [gui_element_ids.constr_element_id, gui_element_ids.constr_decl_stmt_id],
    ...
    expr_spec_in_func_reading_modifying_field_focused_element: {
        ...
        desc: "Design rules for expression statements in methods reading / modifying the target field",
        headers: ["IF a method has these properties", "THEN the method may have these expressions"],
        mergeKeys: ["function", "expression statement"],
        categorizedFeatureSets: [["func_identifier", "func_spec"], []],
        rootId: [gui_element_ids.func_element_id, gui_element_ids.func_expr_stmt_id],
    ...
    decl_spec_in_func_reading_modifying_field_focused_element: {
        ...
        desc: "Design rules for declaration statements in methods reading / modifying the target field",
        headers: ["IF a method has these properties", "THEN the method may have these declarations"],
        mergeKeys: ["function", "declaration statement"],
        categorizedFeatureSets: [["func_identifier", "func_spec"], []],
        rootId: [gui_element_ids.func_element_id, gui_element_ids.func_decl_stmt_id],
