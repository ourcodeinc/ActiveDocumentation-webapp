...
myGrammarLexer.SPACE = 13;
myGrammarLexer.Alphabet = 14;
myGrammarLexer.NL = 15;
myGrammarLexer.Comma = 16;
myGrammarLexer.LPAREN = 17;
myGrammarLexer.RPAREN = 18;
myGrammarLexer.NAME = 19;
myGrammarLexer.ANNOTATION = 20;
myGrammarLexer.EXTEND = 21;
myGrammarLexer.EXTENSION = 22;
myGrammarLexer.IMPLEMENTATION = 23;
myGrammarLexer.FUNCTION = 24;
myGrammarLexer.AbstractFunctions = 25;
myGrammarLexer.CONSTRUCTOR = 26;
myGrammarLexer.PARAMETER = 27;
myGrammarLexer.TYPES = 28;
myGrammarLexer.SPECIFIER = 29;
myGrammarLexer.ReturnValue = 30;
myGrammarLexer.DeclarationStatement = 31;
myGrammarLexer.ExpressionStatement = 32;
myGrammarLexer.InitValue = 33;
myGrammarLexer.ARGUMENT = 34;
myGrammarLexer.CALL = 35;
myGrammarLexer.CALLER = 36;
myGrammarLexer.VALUE = 37;
myGrammarLexer.CLASSES = 38;

myGrammarLexer.prototype.channelNames = [ "DEFAULT_TOKEN_CHANNEL", "HIDDEN" ];

myGrammarLexer.prototype.modeNames = [ "DEFAULT_MODE" ];

myGrammarLexer.prototype.literalNames = [ null, "'.'", "'be'", "'must'", 
                                          "'must be equal to'", "'where'", 
                                          "'of'", "'and'", "'or'", "'have'", 
                                          "'equal to'", "'include'", "'not'", 
                                          null, null, null, "','", "'('", 
                                          "')'", "'name'", "'annotation'", 
...
myGrammarLexer.prototype.symbolicNames = [ null, null, null, null, null, 
                                           ...
                                           null, null, null, "SPACE", "Alphabet", 
                                           "NL", "Comma", "LPAREN", "RPAREN", 
                                           "NAME", "ANNOTATION", "EXTEND", 
...
myGrammarLexer.prototype.ruleNames = [ "T__0", "T__1", "T__2", "T__3", "T__4", 
                                       ...
                                       "T__10", "T__11", "SPACE", "Alphabet", 
                                       "NL", "Comma", "LPAREN", "RPAREN", 
                                       "NAME", "ANNOTATION", "EXTEND", "EXTENSION", 
                                       "IMPLEMENTATION", "FUNCTION", "AbstractFunctions", 
                                       "CONSTRUCTOR", "PARAMETER", "TYPES", 
                                       "SPECIFIER", "ReturnValue", "DeclarationStatement", 
                                       "ExpressionStatement", "InitValue", 
