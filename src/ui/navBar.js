                ...
                window.location.hash =
                  key === 1
                    ...
                    : key === 2
                      ? `#/${hashConst.rules}`
                      : key === 3
                        ? `#/${hashConst.violatedRules}`
                        : key === 4
                          ? `#/${hashConst.learnDesignRules}`
                          : `#/${hashConst.index}`;
            }}
          >
            <NavItem
              eventKey={-1}
              className={this.props.backDisable}
            ...
            <NavItem
              eventKey={-2}
              className={this.props.forwardDisable}
              onClick={() => this.props.forwardClick(this.props)}
            >
              <FaArrowRight size={20} />
            </NavItem>

            <NavItem eventKey={1}>Table of Contents</NavItem>
            <NavItem eventKey={2}>All Rules</NavItem>
            <NavItem eventKey={3}>Violated Rules</NavItem>
